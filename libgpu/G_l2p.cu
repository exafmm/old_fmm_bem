...
#define G_L2P_KERNEL_CORE \
      ...
      veck[4*tx+0]+=0.25/M_PI*gx;\
      veck[4*tx+1]+=0.25/M_PI*gy;\
      veck[4*tx+2]+=0.25/M_PI*gz;\
      veck[4*tx+3]+=0.25/M_PI*g;
